...
namespace WingsEmu.PacketHandlers
{
    public class InventoryPacketHandler : IPacketHandler
    {
        ...
        public void EquipmentInfo(EquipmentInfoPacket equipmentInfoPacket)
        {
            ...
            switch (equipmentInfoPacket.Type)
            {
                ...
                case 7:
                    ...
                    inventory = value != 12
                        ? Session.Character.Inventory.LoadBySlotAndType<WearableInstance>(value, invType)
                        : Session.Character.Inventory.LoadBySlotAndType<SpecialistInstance>(value, invType);
                    break;
        ...
        public void ExchangeList(string packet)
        {
            ...
            if (bankGold < 0 || bankGold > Session.Account.BankMoney / 1000 || gold < 0 || gold > Session.Character.Gold || Session.Character.ExchangeInfo == null ||
                Session.Character.ExchangeInfo.ExchangeList.Any())
            {
                return;
            }
        ...
        {
            if (Session.Character.LastSkillUse.AddSeconds(1) > DateTime.Now || Session.Character.IsVehicled && Session.CurrentMapInstance?.MapInstanceType != MapInstanceType.EventGameInstance ||
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (mapItem is MonsterMapItem droppedGold && Session.Character.Gold + droppedGold.GoldAmount <= maxGold)
                    {
                        ...
                        int goldDropped = (int)(droppedGold.GoldAmount * (1 + Session.Character.GetBuff(BCardType.CardType.Item, (byte)AdditionalTypes.Item.IncreaseEarnedGold)[0] / 100D));
        ...
        public void SpecialistHolder(SpecialistHolderPacket specialistHolderPacket)
        {
            ...
            else if (specialistHolderPacket.HolderType == 1)
            {
                ...
                if (specialist == null || holder == null)
                {
                    Logger.Log.Warn("Specialist or holder null");
                    return;
                }
