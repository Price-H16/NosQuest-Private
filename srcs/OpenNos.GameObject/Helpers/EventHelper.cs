        ...
        public void RunEvent(EventContainer evt, ClientSession session = null, MapMonster monster = null)
        {
            ...
            switch (evt.EventActionType)
            {
                    ...
                    switch (evt.MapInstance.MapInstanceType)
                    {
                        ...
                        case MapInstanceType.RaidInstance:
                                ...
                                evt.MapInstance) // Act 4 raids
                            {
                                ...
                                {
                                    if (DaoFactory.Instance.RaidLogDao.LoadByFamilyId(cli.Character.Family.FamilyId).Any(s =>
                                ...
                                evt.MapInstance.Monsters.Any(s => s.IsBoss && !s.IsAlive))
                            {
                                    ...
                                    s.CurrentMapInstance?.Monsters.Any(e => e.IsBoss) == true))
                                {
                                    ...
                                    if (DaoFactory.Instance.RaidLogDao.LoadByCharacterId(sess.Character.CharacterId).Any(s =>
                ...
                case EventActionType.TELEPORT:
                    ...
                    List<Character.Character> characters = evt.MapInstance.GetCharactersInRange(tp.Item1, tp.Item2, 5).ToList();
                ...
                case EventActionType.SPAWNONLASTENTRY:
                    Character.Character lastincharacter = evt.MapInstance.Sessions.OrderByDescending(s => s.RegisterTime)
