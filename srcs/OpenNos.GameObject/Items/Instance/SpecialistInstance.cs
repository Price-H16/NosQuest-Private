...
namespace OpenNos.GameObject.Items.Instance
{
    public class SpecialistInstance : WearableInstance, ISpecialistInstance
    {
        ...
        public string GeneratePslInfo() =>
            $"pslinfo {Item.VNum} {Item.Element} {Item.ElementRate} {Item.LevelJobMinimum} {Item.Speed} {Item.FireResistance} {Item.WaterResistance} {Item.LightResistance} {Item.DarkResistance} {PartnerSkill1}.{SkillRank1} {PartnerSkill2}.{SkillRank2} {PartnerSkill3}.{SkillRank3}";
