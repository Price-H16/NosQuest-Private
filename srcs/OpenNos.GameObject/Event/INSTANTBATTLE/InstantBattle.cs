...
namespace OpenNos.GameObject.Event.INSTANTBATTLE
{
    public static class InstantBattle
    {
        ...
        private static List<Tuple<short, int, short, short>> GetInstantBattleDrop(Map map, short instantbattletype,
            int wave)
        {
            List<Tuple<short, int, short, short>> dropParameters = new List<Tuple<short, int, short, short>>();
        ...
        private static ConcurrentBag<ToSummon> GetInstantBattleMonster(Map map, short instantbattletype, int wave)
        {
